...
import {
  AdminWorkflowEditorUnsavedProvider,
  useWorkflowEditorLeaveConfirmHandler,
} from '@/context/AdminWorkflowEditorUnsavedContext'
  ...
  return (
    <AdminWorkflowEditorUnsavedProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex">
          <AdminSidebarNav pathname={pathname} items={navItems} />
...
function AdminSidebarNav({
  ...
  const onLeaveClick = useWorkflowEditorLeaveConfirmHandler()
  return (
